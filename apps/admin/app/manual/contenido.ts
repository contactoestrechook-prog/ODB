    ...
    bloques: [
      ...
      },
      {
        ...
        pasos: [
          ...
          'Varias unidades del mismo producto: escaneá una y tocá C, tipeá la cantidad y Enter (C 10 = diez unidades). También podés escribirla en el casillero del renglón, o antes de escanear tipear "6*" para que el próximo entre de a 6.',
    ...
    bloques: [
      {
        ...
        pasos: [
          ...
          'En cada renglón, la primera línea es el papel tal cual (cantidad × precio = importe) para cotejar con la factura. En la columna Costo hay dos números en la misma línea: a la izquierda el precio unitario del papel (sin IVA, se puede corregir) y a la derecha, con la flecha, el costo final c/IVA: el mismo precio más el IVA, las percepciones y los impuestos internos de la factura repartidos entre los renglones. Ese costo final es el que queda en stock y del que sale el margen y el precio de venta. Al lado, × cantidad = el total del renglón a ese costo final.',
    ...
    bloques: [
      {
        ...
        pasos: [
          ...
          'Calidad de las fotos: el catálogo externo no tiene foto propia de todo, así que sale a buscarla. Casi la mitad salen de una base colaborativa donde la gente fotografía el producto con el celular, y llegan con la mano de la persona, la mesa de madera o la heladera de fondo. El botón "Revisar calidad" hace que la IA mire cada foto y saque las que no sirven: ese producto vuelve a quedar sin foto, que se ve mejor que una foto casera. Solo mira la calidad de la imagen, nunca qué producto es.',
