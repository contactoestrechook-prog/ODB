...
export default async function Compras() {
  ...
  try {
    const [rr, ro, rp, rs, rsuc] = await Promise.all([
    ...
    <main className="min-h-screen bg-[#F0EBE2] lg:pl-64">
      ...
      <div className="max-w-5xl mx-auto p-6">
        {error ? (
          ...
          <ComprasWorkspace resumen={resumen} ordenes={ordenes} proveedores={proveedores} sugerencias={sugerencias} sucursales={sucursales} />
        )}
      </div>
    </main>
  );
